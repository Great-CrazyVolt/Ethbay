...
const ProductPurchased = (props) => {
    return (
        <div className=" flex items-center my-8">
            ...
            <Link to='/buyerForm' className="flex-1 ml-4 rounded-md p-2 text-center w-1/5 font-semibold text-mx text-white hover:bg-red-400 bg-red-500" onClick={ () => props.requestForRevertOrder(props.sellerAddress, props.buyerAddress, props.productName, props.productDescription, props.productPrice, props.sellerEmailAddress,)}> Revert  </Link>
