...
export const TransactionProvider = ({ children }) => {
    ...
    const sendToAdminByBuyer = async (e) => {
        ...
        try{
            console.log(`
            Seller: ${sellerAddress}, Buyer: ${buyerAddress}, SellerEmail: ${sellerEmail}, 
            ProductName: ${productName}, Description: ${productDescription}, Price: ${productPrice}, Hash: ${hash}, Message: ${message}`)
            // init('F69kg3OcHO9b9vyMq');
